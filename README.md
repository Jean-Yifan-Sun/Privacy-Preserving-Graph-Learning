Python implementation of "Learning Privacy-Preserving Graph Convolutional Network with Partially Observed Sensitive Attributes" (WWW-2022)[[Link]](https://dl.acm.org/doi/10.1145/3485447.3511975).
